...
BOT_TOKEN = environ.get('BOT_TOKEN', '8100129733:AAF8vMuU15xEDnMU4OR0jdAvYz6m54QObrg')
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6981039468 6861922941 7457122085 7033932663').split()]
...
OWNER_LINK = environ.get('OWNER_LINK', 'https://telegram.me/itz_pabloescobar')
